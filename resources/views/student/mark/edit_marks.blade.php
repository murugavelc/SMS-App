        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">Select Semester to update Marks</div>
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{URL::to('/student/mark/update_marks')}}" enctype="multipart/form-data">
