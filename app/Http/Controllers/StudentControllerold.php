...
class StudentController extends Controller {
    ...
    public function searchIndex()
    {
        ...
        if(Input::has('rollno')) {
            $students = $students->where('rollno', 'like', '%' . Input::get('rollno') . '%');
        }
        if(Input::has('degree')){
            $students = $students->where('degree', 'like', '%' . Input::get('degree') . '%');
        }
        if(Input::has('department')){
            $string = preg_replace('/\s+/', ' ',  Input::get('department'));
            $students = $students->where('department', 'like', '%' . $string . '%');
        }
        if(Input::has('year')){
            $students = $students->where('year', 'like', '%' . Input::get('year') . '%');
        }
        if(Input::has('section')){
            $students = $students->where('section', 'like', '%' . Input::get('section') . '%');
        }
        if(Input::has('name')) {
            $students = $students->where('name', 'like', '%' . Input::get('name') . '%');
        }
        if(Input::has('gender')){
            $students = $students->where('gender', 'like', '%' . Input::get('gender') . '%');
        }
